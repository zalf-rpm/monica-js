...
var Configuration=function(e,r,a){function t(e,r){var a=!0,t=r.length;logger(MSG.INFO,"Fetching "+t+" crops.");for(var s=0;t>s;s++){var g=r[s],d=g.name.id;(!d||0>d||isNaN(d))&&(a=!1,logger(MSG.ERROR,"Invalid crop id: "+d+"."));var m=new Date(Date.parse(g.sowingDate)),u=new Date(Date.parse(g.finalHarvestDate));debug(m,"sd"),debug(u,"hd"),m.isValid()&&u.isValid()||(a=!1,logger(MSG.ERROR,"Invalid sowing or harvest date."));var c=new Crop(d,g.name.name+", "+g.name.gen_type);c.setSeedAndHarvestDate(m,u),c.setCropParameters(getCropParameters(c.id())),c.setResidueParameters(getResidueParameters(c.id())),e[s]=new ProductionProcess(g.name.name+", "+g.name.gen_type,c);var p=g.tillageOperations;p&&(i(e[s],p)||(a=!1,logger(MSG.ERROR,"Error adding tillages.")));var v=g.mineralFertilisers;v&&(n(e[s],v,!1)||(a=!1,logger(MSG.ERROR,"Error adding mineral fertilisers.")));var h=g.organicFertilisers;h&&(n(e[s],h,!0)||(a=!1,logger(MSG.ERROR,"Error adding organic fertilisers.")));var S=g.irrigations;S&&(o(e[s],S)||(a=!1,logger(MSG.ERROR,"Error adding irrigations.")));var R=g.cuttings;R&&(l(e[s],R)||(a=!1,logger(MSG.ERROR,"Error adding cuttings."))),logger(MSG.INFO,"Fetched crop "+s+", name: "+g.name.name+", id: "+d+".")}return a}function i(e,r){var a=!0,t=r.length;logger(MSG.INFO,"Fetching "+t+" tillages.");for(var i=0;t>i;++i){var n=r[i];if(null!==n.date&&null!==n.depth&&null!==n.method){{var o=new Date(Date.parse(n.date)),l=n.depth/100;n.method}o.isValid()||(a=!1,logger(MSG.ERROR,"Invalid tillage date in tillage no. "+i+".")),e.addApplication(new TillageApplication(o,l)),logger(MSG.INFO,"Fetched tillage "+i+".")}else logger(MSG.WARN,"At least one tillage parameter null: tillage "+i+" ignored.")}return a}function n(e,r,a){var t=!0,i=r.length;logger(MSG.INFO,"Fetching "+i+" "+(a?"organic":"mineral")+" fertilisers.");for(var n=0;i>n;++n){var o=r[n];if(null!==o.date&&null!==o.method&&null!==o.type&&null!==o.amount){var l=new Date(Date.parse(o.date)),s=(o.method,o.type),g=o.amount;if(l.isValid()||(t=!1,logger(MSG.ERROR,"Invalid fertilization date in "+n+".")),a){var d=s.id;0>d&&(logger(MSG.ERROR,"Organic fertilser "+s.id+" not found."),t=!1),e.addApplication(new OrganicFertiliserApplication(l,getOrganicFertiliserParameters(d),g,!0))}else{var m=s.id;0>m&&(logger(MSG.ERROR,"Mineral fertilser "+s.id+" not found."),t=!1),e.addApplication(new MineralFertiliserApplication(l,getMineralFertiliserParameters(m),g))}logger(MSG.INFO,"Fetched "+(a?"organic":"mineral")+" fertiliser "+n+".")}else logger(MSG.WARN,"At least one fertiliser parameter null: "+(a?"organic":"mineral")+" fertiliser "+n+"ignored.")}return t}function o(e,r){var a=!0,t=r.length;logger(MSG.INFO,"Fetching "+t+" irrigations.");for(var i=0;t>i;++i){var n=r[i];if(null!==n.date&&null!==n.method&&null!==n.eventType&&null!==n.threshold&&null!==n.amount&&null!==n.NConc){var o=(n.method,n.eventType,n.threshold,n.area,n.amount),l=n.NConc,s=new Date(Date.parse(n.date));s.isValid()||(a=!1,logger(MSG.ERROR,"Invalid irrigation date in "+i+".")),e.addApplication(new IrrigationApplication(s,o,new IrrigationParameters(l,0))),logger(MSG.INFO,"Fetched irrigation "+i+".")}else logger(MSG.WARN,"At least one irrigation parameter null: irrigation "+i+" ignored.")}return a}function l(e,r){var a=!0,t=r.length;logger(MSG.INFO,"Fetching "+t+" cuttings.");for(var i=0;t>i;++i){var n=r[i],o=new Date(Date.parse(n.date));e.addApplication(new Cutting(o,e.crop(),e.cropResult()))}return a}function s(e){var a=!1;return r&&(e.addClimateData(Climate.tmin,new Float64Array(r.tmin)),e.addClimateData(Climate.tmax,new Float64Array(r.tmax)),e.addClimateData(Climate.tavg,new Float64Array(r.tavg)),e.addClimateData(Climate.globrad,new Float64Array(r.globrad)),e.addClimateData(Climate.wind,new Float64Array(r.wind)),e.addClimateData(Climate.precip,new Float64Array(r.precip)),r.sunhours.length>0&&e.addClimateData(Climate.sunhours,new Float64Array(r.sunhours)),r.relhumid.length>0&&e.addClimateData(Climate.relhumid,new Float64Array(r.relhumid)),a=!0),a}DEBUG=a===!0?!0:!1;var g=e,d=function(e,r,a){logger(MSG.INFO,"Fetching parameters from database.");var i=new SiteParameters,n=readUserParameterFromDatabase(),o=new GeneralParameters(n.userEnvironmentParameters.p_LayerThickness,n.userEnvironmentParameters.p_LayerThickness*n.userEnvironmentParameters.p_NumberOfLayers),l=r.horizons,d=a.crops,c=new Date(Date.parse(e.time.startDate)).getFullYear(),p=new Date(Date.parse(e.time.endDate)).getFullYear();n.userEnvironmentParameters.p_UseSecondaryYields=e.switch.useSecondaryYieldOn===!0?!0:!1,o.pc_NitrogenResponseOn=e.switch.nitrogenResponseOn===!0?!0:!1,o.pc_WaterDeficitResponseOn=e.switch.waterDeficitResponseOn===!0?!0:!1,o.pc_EmergenceMoistureControlOn=e.switch.emergenceMoistureControlOn===!0?!0:!1,o.pc_EmergenceFloodingControlOn=e.switch.emergenceFloodingControlOn===!0?!0:!1,n.userInitValues.p_initPercentageFC=e.init.percentageFC,n.userInitValues.p_initSoilNitrate=e.init.soilNitrate,n.userInitValues.p_initSoilAmmonium=e.init.soilAmmonium,logger(MSG.INFO,"Fetched sim data."),i.vq_NDeposition=r.NDeposition,i.vs_Latitude=r.latitude,i.vs_Slope=r.slope,i.vs_HeightNN=r.heightNN,i.vs_Soil_CN_Ratio=10,i.vs_DrainageCoeff=-1,n.userEnvironmentParameters.p_AthmosphericCO2=r.atmosphericCO2,n.userEnvironmentParameters.p_WindSpeedHeight=r.windSpeedHeight,n.userEnvironmentParameters.p_LeachingDepth=r.leachingDepth,o.ps_MaxMineralisationDepth=.4,logger(MSG.INFO,"Fetched site data.");var v=100*n.userEnvironmentParameters.p_LayerThickness,h=200,S=int(h/v),R=[];if(!m(R,l,v,S))return void logger(MSG.ERROR,"Error fetching soil data.");logger(MSG.INFO,"Fetched soil data.");var F=new DataAccessor(new Date(c,0,1),new Date(p,11,31));if(!s(F,n,i.vs_Latitude))return void logger(MSG.ERROR,"Error fetching climate data.");logger(MSG.INFO,"Fetched climate data.");var O=[];if(!t(O,d))return void logger(MSG.ERROR,"Error fetching crop data.");logger(MSG.INFO,"Fetched crop data.");var M=new Environment(R,n);return M.general=o,M.pathToOutputDir=g,M.site=i,M.da=F,M.cropRotation=O,logger(MSG.INFO,"Start monica model."),runMonica(M,u)},m=function(e,r,a,t){var i=!0,n=r.length,o=0;logger(MSG.INFO,"Fetching "+n+" horizons.");for(var l=0;n>l;++l){debug("lThicknessCm",a),debug("maxNoOfLayers",t),debug("depth",o);var s=r[l],g=100*s.thickness,d=int(round(g/a));l==n-1&&int(e.length)+d<t&&(d+=t-e.length-d);for(var m=0;d>m;m++){if(o===t*a){logger(MSG.WARN,"Maximum soil layer depth ("+t*a+" cm) reached. Remaining layers in horizon "+l+" ignored.");break}o+=a;var u=new SoilParameters;u.set_vs_SoilOrganicCarbon(s.Corg),s.bulkDensity&&u.set_vs_SoilBulkDensity(s.bulkDensity),u.vs_SoilSandContent=s.sand,u.vs_SoilClayContent=s.clay,u.vs_SoilStoneContent=s.sceleton,u.vs_Lambda=Tools.texture2lambda(u.vs_SoilSandContent,u.vs_SoilClayContent),u.vs_SoilTexture=s.textureClass,u.vs_SoilpH=s.pH,u.vs_Lambda=Tools.texture2lambda(u.vs_SoilSandContent,u.vs_SoilClayContent),u.vs_FieldCapacity=s.fieldCapacity,u.vs_Saturation=s.poreVolume,u.vs_PermanentWiltingPoint=s.permanentWiltingPoint,u.isValid()||(i=!1,logger(MSG.ERROR,"Error in soil parameters.")),e.push(u),logger(MSG.INFO,"Fetched layer "+e.length+" in horizon "+l+".")}logger(MSG.INFO,"Fetched horizon "+l+".")}return i},u=function(e){ENVIRONMENT_IS_WORKER?postMessage({progress:e}):logger(MSG.INFO,pRogress.date)};return{run:d}};

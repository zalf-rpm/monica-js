...
var getCropParameters=function(e){var t=new CropParameters,a=db.exec("SELECT id, name, perennial, max_assimilation_rate,     carboxylation_pathway, minimum_temperature_for_assimilation,     crop_specific_max_rooting_depth, min_n_content,     n_content_pn, n_content_b0,     n_content_above_ground_biomass, n_content_root, initial_kc_factor,     development_acceleration_by_nitrogen_stress, fixing_n,     luxury_n_coeff, max_crop_height, residue_n_ratio,     sampling_depth, target_n_sampling_depth, target_n30,     default_radiation_use_efficiency, crop_height_P1, crop_height_P2,     stage_at_max_height, max_stem_diameter, stage_at_max_diameter,     heat_sum_irrigation_start, heat_sum_irrigation_end,     max_N_uptake_p, root_distribution_p, plant_density,     root_growth_lag, min_temperature_root_growth, initial_rooting_depth,     root_penetration_rate, root_form_factor, specific_root_length,     stage_after_cut, crit_temperature_heat_stress,     lim_temperature_heat_stress, begin_sensitive_phase_heat_stress,     end_sensitive_phase_heat_stress, drought_impact_on_fertility_factor,     cutting_delay_days, field_condition_modifier, assimilate_reallocation     FROM crop     WHERE id = "+e);if(1!=a[0].values.length)throw"cropId ("+e+") not available in table crop";var i=a[0].columns,r=a[0].values[0];t.pc_CropName=r[i.indexOf("name")],t.pc_MaxAssimilationRate=r[i.indexOf("max_assimilation_rate")],t.pc_CarboxylationPathway=r[i.indexOf("carboxylation_pathway")],t.pc_MinimumTemperatureForAssimilation=r[i.indexOf("minimum_temperature_for_assimilation")],t.pc_CropSpecificMaxRootingDepth=r[i.indexOf("crop_specific_max_rooting_depth")],t.pc_MinimumNConcentration=r[i.indexOf("min_n_content")],t.pc_NConcentrationPN=r[i.indexOf("n_content_pn")],t.pc_NConcentrationB0=r[i.indexOf("n_content_b0")],t.pc_NConcentrationAbovegroundBiomass=r[i.indexOf("n_content_above_ground_biomass")],t.pc_NConcentrationRoot=r[i.indexOf("n_content_root")],t.pc_InitialKcFactor=r[i.indexOf("initial_kc_factor")],t.pc_DevelopmentAccelerationByNitrogenStress=r[i.indexOf("development_acceleration_by_nitrogen_stress")],t.pc_FixingN=r[i.indexOf("fixing_n")],t.pc_LuxuryNCoeff=r[i.indexOf("luxury_n_coeff")],t.pc_MaxCropHeight=r[i.indexOf("max_crop_height")],t.pc_ResidueNRatio=r[i.indexOf("residue_n_ratio")],t.pc_SamplingDepth=r[i.indexOf("sampling_depth")],t.pc_TargetNSamplingDepth=r[i.indexOf("target_n_sampling_depth")],t.pc_TargetN30=r[i.indexOf("target_n30")],t.pc_DefaultRadiationUseEfficiency=r[i.indexOf("default_radiation_use_efficiency")],t.pc_CropHeightP1=r[i.indexOf("crop_height_P1")],t.pc_CropHeightP2=r[i.indexOf("crop_height_P2")],t.pc_StageAtMaxHeight=r[i.indexOf("stage_at_max_height")],t.pc_MaxCropDiameter=r[i.indexOf("max_stem_diameter")],t.pc_StageAtMaxDiameter=r[i.indexOf("stage_at_max_diameter")],t.pc_HeatSumIrrigationStart=r[i.indexOf("heat_sum_irrigation_start")],t.pc_HeatSumIrrigationEnd=r[i.indexOf("heat_sum_irrigation_end")],t.pc_MaxNUptakeParam=r[i.indexOf("max_N_uptake_p")],t.pc_RootDistributionParam=r[i.indexOf("root_distribution_p")],t.pc_PlantDensity=r[i.indexOf("plant_density")],t.pc_RootGrowthLag=r[i.indexOf("root_growth_lag")],t.pc_MinimumTemperatureRootGrowth=r[i.indexOf("min_temperature_root_growth")],t.pc_InitialRootingDepth=r[i.indexOf("initial_rooting_depth")],t.pc_RootPenetrationRate=r[i.indexOf("root_penetration_rate")],t.pc_RootFormFactor=r[i.indexOf("root_form_factor")],t.pc_SpecificRootLength=r[i.indexOf("specific_root_length")],t.pc_StageAfterCut=r[i.indexOf("stage_after_cut")],t.pc_CriticalTemperatureHeatStress=r[i.indexOf("crit_temperature_heat_stress")],t.pc_LimitingTemperatureHeatStress=r[i.indexOf("lim_temperature_heat_stress")],t.pc_BeginSensitivePhaseHeatStress=r[i.indexOf("begin_sensitive_phase_heat_stress")],t.pc_EndSensitivePhaseHeatStress=r[i.indexOf("end_sensitive_phase_heat_stress")],t.pc_DroughtImpactOnFertilityFactor=r[i.indexOf("drought_impact_on_fertility_factor")],t.pc_CuttingDelayDays=r[i.indexOf("cutting_delay_days")],t.pc_FieldConditionModifier=r[i.indexOf("field_condition_modifier")];var a=db.exec("SELECT o.crop_id, o.id, o.initial_organ_biomass,     o.organ_maintainance_respiration, o.is_above_ground,     o.organ_growth_respiration, o.is_storage_organ     FROM organ as o inner join crop as c on c.id = o.crop_id     WHERE crop_id = "+e+"     ORDER BY o.crop_id, c.id");if(0===a[0].values.length)throw"cropId ("+e+") not available in table organ";for(var i=a[0].columns,o=a[0].values,n=0,_=o.length;_>n;n++){var r=o[n];t.pc_NumberOfOrgans++,t.pc_InitialOrganBiomass.push(r[i.indexOf("initial_organ_biomass")]),t.pc_OrganMaintenanceRespiration.push(r[i.indexOf("organ_maintainance_respiration")]),t.pc_AbovegroundOrgan.push(1==r[i.indexOf("is_above_ground")]),t.pc_OrganGrowthRespiration.push(r[i.indexOf("organ_growth_respiration")]),t.pc_StorageOrgan.push(1==r[i.indexOf("is_storage_organ")])}var a=db.exec("SELECT id, stage_temperature_sum,     base_temperature, opt_temperature, vernalisation_requirement,     day_length_requirement, base_day_length,     drought_stress_threshold, critical_oxygen_content,     specific_leaf_area, stage_max_root_n_content,     stage_kc_factor     FROM dev_stage     WHERE crop_id = "+e+"     order by id");if(0===a[0].values.length)throw"cropId ("+e+") not available in table dev_stage";for(var i=a[0].columns,o=a[0].values,n=0,_=o.length;_>n;n++){var r=o[n];t.pc_NumberOfDevelopmentalStages++,t.pc_StageTemperatureSum.push(r[i.indexOf("stage_temperature_sum")]),t.pc_BaseTemperature.push(r[i.indexOf("base_temperature")]),t.pc_OptimumTemperature.push(r[i.indexOf("opt_temperature")]),t.pc_VernalisationRequirement.push(r[i.indexOf("vernalisation_requirement")]),t.pc_DaylengthRequirement.push(r[i.indexOf("day_length_requirement")]),t.pc_BaseDaylength.push(r[i.indexOf("base_day_length")]),t.pc_DroughtStressThreshold.push(r[i.indexOf("drought_stress_threshold")]),t.pc_CriticalOxygenContent.push(r[i.indexOf("critical_oxygen_content")]),t.pc_SpecificLeafArea.push(r[i.indexOf("specific_leaf_area")]),t.pc_StageMaxRootNConcentration.push(r[i.indexOf("stage_max_root_n_content")]),t.pc_StageKcFactor.push(r[i.indexOf("stage_kc_factor")])}t.resizeStageOrganVectors();for(var a=db.exec("SELECT crop_id, organ_id, dev_stage_id,     ods_dependent_param_id, value     FROM crop2ods_dependent_param     WHERE crop_id = "+e+"     ORDER BY crop_id, ods_dependent_param_id, dev_stage_id, organ_id"),i=a[0].columns,o=a[0].values,n=0,_=o.length;_>n;n++){var r=o[n],s=r[i.indexOf("ods_dependent_param_id")],l=r[i.indexOf("dev_stage_id")],c=r[i.indexOf("organ_id")],g=1===s?t.pc_AssimilatePartitioningCoeff:t.pc_OrganSenescenceRate;g[l-1][c-1]=r[i.indexOf("value")]}for(var a=db.exec("SELECT crop_id, organ_id, is_primary, percentage, dry_matter     FROM yield_parts     WHERE crop_id = "+e),i=a[0].columns,o=a[0].values,n=0,_=o.length;_>n;n++){var r=o[n],p=r[i.indexOf("organ_id")],d=r[i.indexOf("percentage")]/100,m=r[i.indexOf("dry_matter")];1==r[i.indexOf("is_primary")]?t.organIdsForPrimaryYield.push(new YieldComponent(p,d,m)):t.organIdsForSecondaryYield.push(new YieldComponent(p,d,m))}var a=db.exec("SELECT crop_id, organ_id, is_primary, percentage, dry_matter     FROM cutting_parts     WHERE crop_id = "+e);if(a.length>0)for(var i=a[0].columns,o=a[0].values,n=0,_=o.length;_>n;n++){var r=o[n],p=r[i.indexOf("organ_id")],d=r[i.indexOf("percentage")]/100,m=r[i.indexOf("dry_matter")];18===e?t.organIdsForPrimaryYield.push(new YieldComponent(p,d,m)):t.organIdsForCutting.push(new YieldComponent(p,d,m))}return t},getMineralFertiliserParameters=function(e){var t=db.exec("SELECT id, name, no3, nh4, carbamid     FROM mineral_fertilisers     WHERE id = "+e);if(1!=t[0].values.length)throw"mineral fertiliser id ("+e+") not available in table mineral_fertilisers";var a=t[0].columns,i=t[0].values[0],r=i[a.indexOf("name")],o=i[a.indexOf("carbamid")],n=i[a.indexOf("no3")],_=i[a.indexOf("nh4")];return new MineralFertiliserParameters(r,o,n,_)},getOrganicFertiliserParameters=function(e){var t=db.exec("SELECT om_type, dm, nh4_n, no3_n, nh2_n, k_slow, k_fast, part_s, part_f, cn_s, cn_f, smb_s, smb_f, id     FROM organic_fertiliser     WHERE id = "+e);if(1!=t[0].values.length)throw"organic fertiliser id ("+e+") not available in table organic_fertiliser";var a=t[0].columns,i=t[0].values[0],r=new OrganicMatterParameters;return r.name=i[a.indexOf("om_type")],r.vo_AOM_DryMatterContent=i[a.indexOf("dm")],r.vo_AOM_NH4Content=i[a.indexOf("nh4_n")],r.vo_AOM_NO3Content=i[a.indexOf("no3_n")],r.vo_AOM_CarbamidContent=i[a.indexOf("nh2_n")],r.vo_AOM_SlowDecCoeffStandard=i[a.indexOf("k_slow")],r.vo_AOM_FastDecCoeffStandard=i[a.indexOf("k_fast")],r.vo_PartAOM_to_AOM_Slow=i[a.indexOf("part_s")],r.vo_PartAOM_to_AOM_Fast=i[a.indexOf("part_f")],r.vo_CN_Ratio_AOM_Slow=i[a.indexOf("cn_s")],r.vo_CN_Ratio_AOM_Fast=i[a.indexOf("cn_f")],r.vo_PartAOM_Slow_to_SMB_Slow=i[a.indexOf("smb_s")],r.vo_PartAOM_Slow_to_SMB_Fast=i[a.indexOf("smb_f")],r},getResidueParameters=function(e){var t=db.exec("SELECT residue_type, dm, nh4, no3, nh2, k_slow, k_fast, part_s, part_f, cn_s, cn_f, smb_s, smb_f, crop_id     FROM residue_table     WHERE crop_id = "+e),a=t[0].columns,i=t[0].values[0],r=new OrganicMatterParameters;return i&&(r.name=i[a.indexOf("residue_type")],r.vo_AOM_DryMatterContent=i[a.indexOf("dm")],r.vo_AOM_NH4Content=i[a.indexOf("nh4")],r.vo_AOM_NO3Content=i[a.indexOf("no3")],r.vo_AOM_CarbamidContent=i[a.indexOf("nh2")],r.vo_AOM_SlowDecCoeffStandard=i[a.indexOf("k_slow")],r.vo_AOM_FastDecCoeffStandard=i[a.indexOf("k_fast")],r.vo_PartAOM_to_AOM_Slow=i[a.indexOf("part_s")],r.vo_PartAOM_to_AOM_Fast=i[a.indexOf("part_f")],r.vo_CN_Ratio_AOM_Slow=i[a.indexOf("cn_s")],r.vo_CN_Ratio_AOM_Fast=i[a.indexOf("cn_f")],r.vo_PartAOM_Slow_to_SMB_Slow=i[a.indexOf("smb_s")],r.vo_PartAOM_Slow_to_SMB_Fast=i[a.indexOf("smb_f")]),r},readCapillaryRiseRates=function(){for(var e=db.exec("SELECT soil_type, distance, capillary_rate FROM capillary_rise_rate"),t=e[0].columns,a=e[0].values,i=new CapillaryRiseRates,r=0,o=a.length;o>r;r++){var n=a[r],_=n[t.indexOf("soil_type")],s=n[t.indexOf("distance")],l=n[t.indexOf("capillary_rate")];i.addRate(_,s,l)}return i},readUserParameterFromDatabase=function(){for(var e=db.exec("SELECT name, value_hermes FROM user_parameter"),t=e[0].columns,a=e[0].values,i=new CentralParameterProvider,r=i.userCropParameters,o=i.userEnvironmentParameters,n=i.userSoilMoistureParameters,_=i.userSoilTemperatureParameters,s=i.userSoilTransportParameters,l=i.userSoilOrganicParameters,c=(i.userInitValues,0),g=a.length;g>c;c++){var p=a[c],d=p[t.indexOf("NAME")],m=p[t.indexOf("VALUE_HERMES")];"tortuosity"==d?r.pc_Tortuosity=m:"canopy_reflection_coefficient"==d?r.pc_CanopyReflectionCoefficient=m:"reference_max_assimilation_rate"==d?r.pc_ReferenceMaxAssimilationRate=m:"reference_leaf_area_index"==d?r.pc_ReferenceLeafAreaIndex=m:"maintenance_respiration_parameter_2"==d?r.pc_MaintenanceRespirationParameter2=m:"maintenance_respiration_parameter_1"==d?r.pc_MaintenanceRespirationParameter1=m:"minimum_n_concentration_root"==d?r.pc_MinimumNConcentrationRoot=m:"minimum_available_n"==d?r.pc_MinimumAvailableN=m:"reference_albedo"==d?r.pc_ReferenceAlbedo=m:"stomata_conductance_alpha"==d?r.pc_StomataConductanceAlpha=m:"saturation_beta"==d?r.pc_SaturationBeta=m:"growth_respiration_redux"==d?r.pc_GrowthRespirationRedux=m:"max_crop_n_demand"==d?r.pc_MaxCropNDemand=m:"growth_respiration_parameter_2"==d?r.pc_GrowthRespirationParameter2=m:"growth_respiration_parameter_1"==d?r.pc_GrowthRespirationParameter1=m:"use_automatic_irrigation"==d?o.p_UseAutomaticIrrigation=1==m:"use_nmin_mineral_fertilising_method"==d?o.p_UseNMinMineralFertilisingMethod=1==m:"layer_thickness"==d?o.p_LayerThickness=m:"number_of_layers"==d?o.p_NumberOfLayers=m:"start_pv_index"==d?o.p_StartPVIndex=m:"albedo"==d?o.p_Albedo=m:"athmospheric_co2"==d?o.p_AthmosphericCO2=m:"wind_speed_height"==d?o.p_WindSpeedHeight=m:"use_secondary_yields"==d?o.p_UseSecondaryYields=1==m:"julian_day_automatic_fertilising"==d?o.p_JulianDayAutomaticFertilising=m:"critical_moisture_depth"==d?n.pm_CriticalMoistureDepth=m:"saturated_hydraulic_conductivity"==d?n.pm_SaturatedHydraulicConductivity=m:"surface_roughness"==d?n.pm_SurfaceRoughness=m:"hydraulic_conductivity_redux"==d?n.pm_HydraulicConductivityRedux=m:"snow_accumulation_treshold_temperature"==d?n.pm_SnowAccumulationTresholdTemperature=m:"kc_factor"==d?n.pm_KcFactor=m:"time_step"==d?o.p_timeStep=m:"temperature_limit_for_liquid_water"==d?n.pm_TemperatureLimitForLiquidWater=m:"correction_snow"==d?n.pm_CorrectionSnow=m:"correction_rain"==d?n.pm_CorrectionRain=m:"snow_max_additional_density"==d?n.pm_SnowMaxAdditionalDensity=m:"new_snow_density_min"==d?n.pm_NewSnowDensityMin=m:"snow_retention_capacity_min"==d?n.pm_SnowRetentionCapacityMin=m:"refreeze_parameter_2"==d?n.pm_RefreezeParameter2=m:"refreeze_parameter_1"==d?n.pm_RefreezeParameter1=m:"refreeze_temperature"==d?n.pm_RefreezeTemperature=m:"snowmelt_temperature"==d?n.pm_SnowMeltTemperature=m:"snow_packing"==d?n.pm_SnowPacking=m:"snow_retention_capacity_max"==d?n.pm_SnowRetentionCapacityMax=m:"evaporation_zeta"==d?n.pm_EvaporationZeta=m:"xsa_critical_soil_moisture"==d?n.pm_XSACriticalSoilMoisture=m:"maximum_evaporation_impact_depth"==d?n.pm_MaximumEvaporationImpactDepth=m:"ntau"==d?_.pt_NTau=m:"initial_surface_temperature"==d?_.pt_InitialSurfaceTemperature=m:"base_temperature"==d?_.pt_BaseTemperature=m:"quartz_raw_density"==d?_.pt_QuartzRawDensity=m:"density_air"==d?_.pt_DensityAir=m:"density_water"==d?_.pt_DensityWater=m:"specific_heat_capacity_air"==d?_.pt_SpecificHeatCapacityAir=m:"specific_heat_capacity_quartz"==d?_.pt_SpecificHeatCapacityQuartz=m:"specific_heat_capacity_water"==d?_.pt_SpecificHeatCapacityWater=m:"soil_albedo"==d?_.pt_SoilAlbedo=m:"dispersion_length"==d?s.pq_DispersionLength=m:"AD"==d?s.pq_AD=m:"diffusion_coefficient_standard"==d?s.pq_DiffusionCoefficientStandard=m:"leaching_depth"==d?o.p_LeachingDepth=m:"groundwater_discharge"==d?n.pm_GroundwaterDischarge=m:"density_humus"==d?_.pt_DensityHumus=m:"specific_heat_capacity_humus"==d?_.pt_SpecificHeatCapacityHumus=m:"max_percolation_rate"==d?n.pm_MaxPercolationRate=m:"max_groundwater_depth"==d?o.p_MaxGroundwaterDepth=m:"min_groundwater_depth"==d?o.p_MinGroundwaterDepth=m:"min_groundwater_depth_month"==d?o.p_MinGroundwaterDepthMonth=m:"SOM_SlowDecCoeffStandard"==d?l.po_SOM_SlowDecCoeffStandard=m:"SOM_FastDecCoeffStandard"==d?l.po_SOM_FastDecCoeffStandard=m:"SMB_SlowMaintRateStandard"==d?l.po_SMB_SlowMaintRateStandard=m:"SMB_FastMaintRateStandard"==d?l.po_SMB_FastMaintRateStandard=m:"SMB_SlowDeathRateStandard"==d?l.po_SMB_SlowDeathRateStandard=m:"SMB_FastDeathRateStandard"==d?l.po_SMB_FastDeathRateStandard=m:"SMB_UtilizationEfficiency"==d?l.po_SMB_UtilizationEfficiency=m:"SOM_SlowUtilizationEfficiency"==d?l.po_SOM_SlowUtilizationEfficiency=m:"SOM_FastUtilizationEfficiency"==d?l.po_SOM_FastUtilizationEfficiency=m:"AOM_SlowUtilizationEfficiency"==d?l.po_AOM_SlowUtilizationEfficiency=m:"AOM_FastUtilizationEfficiency"==d?l.po_AOM_FastUtilizationEfficiency=m:"AOM_FastMaxC_to_N"==d?l.po_AOM_FastMaxC_to_N=m:"PartSOM_Fast_to_SOM_Slow"==d?l.po_PartSOM_Fast_to_SOM_Slow=m:"PartSMB_Slow_to_SOM_Fast"==d?l.po_PartSMB_Slow_to_SOM_Fast=m:"PartSMB_Fast_to_SOM_Fast"==d?l.po_PartSMB_Fast_to_SOM_Fast=m:"PartSOM_to_SMB_Slow"==d?l.po_PartSOM_to_SMB_Slow=m:"PartSOM_to_SMB_Fast"==d?l.po_PartSOM_to_SMB_Fast=m:"CN_Ratio_SMB"==d?l.po_CN_Ratio_SMB=m:"LimitClayEffect"==d?l.po_LimitClayEffect=m:"AmmoniaOxidationRateCoeffStandard"==d?l.po_AmmoniaOxidationRateCoeffStandard=m:"NitriteOxidationRateCoeffStandard"==d?l.po_NitriteOxidationRateCoeffStandard=m:"TransportRateCoeff"==d?l.po_TransportRateCoeff=m:"SpecAnaerobDenitrification"==d?l.po_SpecAnaerobDenitrification=m:"ImmobilisationRateCoeffNO3"==d?l.po_ImmobilisationRateCoeffNO3=m:"ImmobilisationRateCoeffNH4"==d?l.po_ImmobilisationRateCoeffNH4=m:"Denit1"==d?l.po_Denit1=m:"Denit2"==d?l.po_Denit2=m:"Denit3"==d?l.po_Denit3=m:"HydrolysisKM"==d?l.po_HydrolysisKM=m:"ActivationEnergy"==d?l.po_ActivationEnergy=m:"HydrolysisP1"==d?l.po_HydrolysisP1=m:"HydrolysisP2"==d?l.po_HydrolysisP2=m:"AtmosphericResistance"==d?l.po_AtmosphericResistance=m:"N2OProductionRate"==d?l.po_N2OProductionRate=m:"Inhibitor_NH3"==d&&(l.po_Inhibitor_NH3=m),i.capillaryRiseRates=readCapillaryRiseRates()}return i},soilCharacteristicsKA5=function(e){logger(MSG.INFO,"soilCharacteristicsKA5");var t=e.vs_SoilTexture,a=e.vs_SoilStoneContent,i=0,r=0,o=0;if(""!=t){var n=e.vs_SoilRawDensity()/1e3,_=100*e.vs_SoilOrganicMatter(),s=0,l=0;1.1>n?(s=1.1,l=1.1):n>=1.1&&1.3>n?(s=1.1,l=1.3):n>=1.3&&1.5>n?(s=1.3,l=1.5):n>=1.5&&1.7>n?(s=1.5,l=1.7):n>=1.7&&1.9>n?(s=1.7,l=1.9):n>=1.9&&(s=1.9,l=1.9),("Hh"==t||"Hn"==t)&&(s=-1,l=-1);var c=readPrincipalSoilCharacteristicData(t,s),g=c.sat,p=c.fc,d=c.pwp,m=readPrincipalSoilCharacteristicData(t,l),f=m.sat,u=m.fc,S=m.pwp;if(c.initialized&&m.initialized){var h=0,O=0;_>=0&&1>_?(h=0,O=0):_>=1&&1.5>_?(h=0,O=1.5):_>=1.5&&3>_?(h=1.5,O=3):_>=3&&6>_?(h=3,O=6):_>=6&&11.5>_?(h=6,O=11.5):_>=11.5&&(h=11.5,O=11.5),("Hh"==t||"Hn"==t)&&(h=0,O=0);var x=0,M=0,y=0;if(0!=h){var c=readSoilCharacteristicModifier(t,h);M=c.sat,x=c.fc,y=c.pwp}var v=0,C=0,N=0;if(0!=O){var m=readSoilCharacteristicModifier(t,O);C=m.sat,v=m.fc,N=m.pwp}var R=p;.5>u&&p>=1?R=p:.5>p&&u>=1?R=u:l!=s&&(R=(n-s)/(l-s)*(u-p)+p);var P=g;.5>f&&g>=1?P=g:.5>g&&f>=1?P=f:l!=s&&(P=(n-s)/(l-s)*(f-g)+g);var w=d;.5>S&&d>=1?w=d:.5>d&&S>=1?w=S:l!=s&&(w=(n-s)/(l-s)*(S-d)+d);var D=x,F=M,A=y;O!=h&&(D=(_-h)/(O-h)*(v-x)+x,F=(_-h)/(O-h)*(C-M)+M,A=(_-h)/(O-h)*(N-y)+y),i=(R+D)/100,r=(P+F)/100,o=(w+A)/100,i*=1-a,r*=1-a,o*=1-a}}e.vs_FieldCapacity=i,e.vs_Saturation=r,e.vs_PermanentWiltingPoint=o},readPrincipalSoilCharacteristicData=function(e,t){var a=db.exec("SELECT soil_type, soil_raw_density*10 AS soil_raw_density, air_capacity, field_capacity, n_field_capacity     FROM soil_characteristic_data     WHERE air_capacity != 0 AND field_capacity != 0 AND n_field_capacity != 0     ORDER BY soil_type, soil_raw_density");if(a[0].values.length<1)throw"soil_characteristic_data not available in monica.sqlite";for(var i=a[0].columns,r=a[0].values,o={},n=0,_=r.length;_>n;n++){var s=r[n];if(s[i.indexOf("soil_type")]===e){var l=s[i.indexOf("air_capacity")],c=s[i.indexOf("field_capacity")],g=s[i.indexOf("n_field_capacity")],p=new RPSCDRes(!0);p.sat=l+c,p.fc=c,p.pwp=c-g,void 0===o[e]&&(o[e]={}),o[e][int(s[i.indexOf("soil_raw_density")])]=p}}var d=int(10*t);if(o[e][d])return o[e][d];for(;!o[e][d]&&d>=11&&19>=d;)d+=15>d?1:-1;return o[e][d]?o[e][d]:new RPSCDRes},readSoilCharacteristicModifier=function(e,t){var a=db.exec("SELECT soil_type, organic_matter*10 AS organic_matter, air_capacity, field_capacity, n_field_capacity     FROM soil_aggregation_values     ORDER BY soil_type, organic_matter");if(a[0].values.length<1)throw"soil_aggregation_values not available in monica.sqlite";for(var i=a[0].columns,r=a[0].values,o={},n=0,_=r.length;_>n;n++){var s=r[n];if(s[i.indexOf("soil_type")]===e){var l=s[i.indexOf("air_capacity")],c=s[i.indexOf("field_capacity")],g=s[i.indexOf("n_field_capacity")],p=new RPSCDRes(!0);p.sat=l+c,p.fc=c,p.pwp=c-g,void 0===o[e]&&(o[e]={}),o[e][int(s[i.indexOf("organic_matter")])]=p}}var d=int(10*t);return o[e][d]?o[e][d]:new RPSCDRes},runMonica=function(e,t){var a={crops:[]};if(ResultId.forEach(function(e){-1===perCropResults.indexOf(e)&&(a[e]=[])}),0===e.cropRotation.length)return logger(MSG.ERROR,"rotation is empty"),a;logger(MSG.INFO,"starting monica");var i=null!=e.pathToOutputDir&&!!fs,r=e.pathToOutputDir+"/rmout.dat",o=e.pathToOutputDir+"/smout.dat",n=e.pathToOutputDir+"/monica_parameters.txt";i&&(initializeFoutHeader(r),initializeGoutHeader(o),dumpMonicaParametersIntoFile(n,e.centralParameterProvider));var _=new Model(e,e.da),s=e.da.startDate(),l=e.da.noOfStepsPossible(),c=s.getMonth(),g=0,p=0,d=0,m=0,f=0,u=0,S=0,h=0,O=0,x=0,M=0,y=0,v=e.cropRotation[y],C=!1,N=v.start(),R=C?N.toAbsoluteDate(s.year()+1):N;if(logger(MSG.INFO,"next app-date: "+N.toString()+" next abs app-date: "+R.toString()),!R.isValid())return logger(MSG.ERROR,"start of production-process: "+v.toString()+" is not valid"),a;for(var P=0;l>P;++P,s=new Date(s.getFullYear(),s.getMonth(),s.getDate()+1),++g){if(logger(MSG.INFO,"currentDate: "+s.getDate()+"."+(s.getMonth()+1)+"."+s.getFullYear()),_.resetDailyCounter(),_.cropGrowth()&&_.cropGrowth().isDying()&&_.incorporateCurrentCrop(),R.setHours(0,0,0,0)==s.setHours(0,0,0,0)){logger(MSG.INFO," applying at: "+N.toString()+" absolute-at: "+R.toString()),v.apply(N,_);var w=N;N=v.nextDate(N),R=C?N.toAbsoluteDate(s.year()+(N.dayOfYear()>w.dayOfYear()?0:1),!0):N,logger(MSG.INFO," next app-date: "+N.toString()+" next abs app-date: "+R.toString()),R.isValid()||(a.crops.push(v.cropResult()),_.resetFertiliserCounter(),v.crop().reset(),y++,y==e.cropRotation.length&&(y=0),v=e.cropRotation[y],N=v.start(),R=C?N.toAbsoluteDate(s.year()+(N.dayOfYear()>w.dayOfYear()?0:1),!0):N,logger(MSG.INFO," new valid next app-date: "+N.toString()+" next abs app-date: "+R.toString())),C&&s>R&&R.addYears(1)}i&&(fs.appendFileSync(o,s.toLocaleDateString(),{encoding:"utf8"}),fs.appendFileSync(r,s.toLocaleDateString(),{encoding:"utf8"})),_.isCropPlanted()&&_.cropStep(P),i&&writeCropResults(_.cropGrowth(),r,o,_.isCropPlanted()),t&&t(getProgress(s,_)),_.generalStep(P),31==s.getDate()&&3==s.getMonth()&&(a.sum90cmYearlyNatDay.push(fixed(10,_.sumNmin(.9))),a.sum30cmSoilTemperature.push(fixed(10,_.sumSoilTemperature(3))),a.sum90cmYearlyNO3AtDay.push(fixed(10,_.sumNO3AtDay(.9))),a.avg30cmSoilTemperature.push(fixed(10,_.avg30cmSoilTemperature())),a.avg0_30cmSoilMoisture.push(fixed(10,_.avgSoilMoisture(0,3))),a.avg30_60cmSoilMoisture.push(fixed(10,_.avgSoilMoisture(3,6))),a.avg60_90cmSoilMoisture.push(fixed(10,_.avgSoilMoisture(6,9))),a.waterFluxAtLowerBoundary.push(fixed(10,_.groundWaterRecharge())),a.avg0_30cmCapillaryRise.push(fixed(10,_.avgCapillaryRise(0,3))),a.avg30_60cmCapillaryRise.push(fixed(10,_.avgCapillaryRise(3,6))),a.avg60_90cmCapillaryRise.push(fixed(10,_.avgCapillaryRise(6,9))),a.avg0_30cmPercolationRate.push(fixed(10,_.avgPercolationRate(0,3))),a.avg30_60cmPercolationRate.push(fixed(10,_.avgPercolationRate(3,6))),a.avg60_90cmPercolationRate.push(fixed(10,_.avgPercolationRate(6,9))),a.evapotranspiration.push(fixed(10,_.getEvapotranspiration())),a.transpiration.push(fixed(10,_.getTranspiration())),a.evaporation.push(fixed(10,_.getEvaporation())),a.sum30cmSMB_CO2EvolutionRate.push(fixed(10,_.get_sum30cmSMB_CO2EvolutionRate())),a.NH3Volatilised.push(fixed(10,_.getNH3Volatilised())),a.sum30cmActDenitrificationRate.push(fixed(10,_.getsum30cmActDenitrificationRate())),a.leachingNAtBoundary.push(fixed(10,_.nLeaching()))),s.getMonth()!=c||P==l-1?(c=s.getMonth(),a.avg10cmMonthlyAvgCorg.push(fixed(10,p/g)),a.avg30cmMonthlyAvgCorg.push(fixed(10,d/g)),a.mean90cmMonthlyAvgWaterContent.push(fixed(10,_.mean90cmWaterContent())),a.monthlySumGroundWaterRecharge.push(fixed(10,f)),a.monthlySumNLeaching.push(fixed(10,u)),a.maxSnowDepth.push(fixed(10,_.maxSnowDepth())),a.sumSnowDepth.push(fixed(10,_.accumulatedSnowDepth())),a.sumFrostDepth.push(fixed(10,_.accumulatedFrostDepth())),a.sumSurfaceRunOff.push(fixed(10,_.sumSurfaceRunOff())),a.sumNH3Volatilised.push(fixed(10,_.getSumNH3Volatilised())),a.monthlySurfaceRunoff.push(fixed(10,O)),a.monthlyPrecip.push(fixed(10,x)),a.monthlyETa.push(fixed(10,M)),a.monthlySoilMoistureL0.push(fixed(10,100*_.avgSoilMoisture(0,1))),a.monthlySoilMoistureL1.push(fixed(10,100*_.avgSoilMoisture(1,2))),a.monthlySoilMoistureL2.push(fixed(10,100*_.avgSoilMoisture(2,3))),a.monthlySoilMoistureL3.push(fixed(10,100*_.avgSoilMoisture(3,4))),a.monthlySoilMoistureL4.push(fixed(10,100*_.avgSoilMoisture(4,5))),a.monthlySoilMoistureL5.push(fixed(10,100*_.avgSoilMoisture(5,6))),a.monthlySoilMoistureL6.push(fixed(10,100*_.avgSoilMoisture(6,7))),a.monthlySoilMoistureL7.push(fixed(10,100*_.avgSoilMoisture(7,8))),a.monthlySoilMoistureL8.push(fixed(10,100*_.avgSoilMoisture(8,9))),a.monthlySoilMoistureL9.push(fixed(10,100*_.avgSoilMoisture(9,10))),a.monthlySoilMoistureL10.push(fixed(10,100*_.avgSoilMoisture(10,11))),a.monthlySoilMoistureL11.push(fixed(10,100*_.avgSoilMoisture(11,12))),a.monthlySoilMoistureL12.push(fixed(10,100*_.avgSoilMoisture(12,13))),a.monthlySoilMoistureL13.push(fixed(10,100*_.avgSoilMoisture(13,14))),a.monthlySoilMoistureL14.push(fixed(10,100*_.avgSoilMoisture(14,15))),a.monthlySoilMoistureL15.push(fixed(10,100*_.avgSoilMoisture(15,16))),a.monthlySoilMoistureL16.push(fixed(10,100*_.avgSoilMoisture(16,17))),a.monthlySoilMoistureL17.push(fixed(10,100*_.avgSoilMoisture(17,18))),a.monthlySoilMoistureL18.push(fixed(10,100*_.avgSoilMoisture(18,19))),p=d=m=f=u=O=0,x=0,M=0,g=0,logger(MSG.INFO,"stored monthly values for month: "+c)):(p+=_.avgCorg(.1),d+=_.avgCorg(.3),m+=_.mean90cmWaterContent(),f+=_.groundWaterRecharge(),u+=_.nLeaching(),O+=_.surfaceRunoff(),x+=e.da.dataForTimestep(Climate.precip,P),M+=_.getETa()),s.getFullYear()!=new Date(s.getFullYear(),s.getMonth(),s.getDate()-1).getFullYear()&&s.getFullYear()!=e.da.startDate().getFullYear()?(a.yearlySumGroundWaterRecharge.push(S),a.yearlySumNLeaching.push(h),S=0,h=0):(S+=_.groundWaterRecharge(),h+=_.nLeaching()),a.dev_stage.push(_.isCropPlanted()?_.cropGrowth().get_DevelopmentalStage()+1:0),i&&writeGeneralResults(r,o,e,_,P)}return logger(MSG.INFO,"returning from runMonica"),t&&t(null),a},initializeFoutHeader=function(e){var t=20,a="",i="\n";a+="Datum     ",a+="	Crop",a+="	TraDef",a+="	Tra",a+="	NDef",a+="	HeatRed",a+="	OxRed",a+="	Stage",a+="	TempSum",a+="	VernF",a+="	DaylF",a+="	IncRoot",a+="	IncLeaf",a+="	IncShoot",a+="	IncFruit",a+="	RelDev",a+="	Root",a+="	Leaf",a+="	Shoot",a+="	Fruit",a+="	Yield",a+="	GroPhot",a+="	NetPhot",a+="	MaintR",a+="	GrowthR",a+="	StomRes",a+="	Height",a+="	LAI",a+="	RootDep",a+="	AbBiom",a+="	NBiom",a+="	SumNUp",a+="	ActNup",a+="	PotNup",a+="	Target",a+="	CritN",a+="	AbBiomN",a+="	NPP",a+="	NPPRoot",a+="	NPPLeaf",a+="	NPPShoot",a+="	NPPFruit",a+="	GPP",a+="	Ra",a+="	RaRoot",a+="	RaLeaf",a+="	RaShoot",a+="	RaFruit";for(var r=0;t>r;r++)a+="	Mois"+r;a+="	Precip",a+="	Irrig",a+="	Infilt",a+="	Surface",a+="	RunOff",a+="	SnowD",a+="	FrostD",a+="	ThawD";for(var r=0;t>r;r++)a+="	PASW-"+r;a+="	SurfTemp",a+="	STemp0",a+="	STemp1",a+="	STemp2",a+="	STemp3",a+="	STemp4",a+="	act_Ev",a+="	act_ET",a+="	ET0",a+="	Kc",a+="	atmCO2",a+="	Groundw",a+="	Recharge",a+="	NLeach";for(var r=0;t>r;r++)a+="	NO3-"+r;a+="	Carb";for(var r=0;t>r;r++)a+="	NH4-"+r;for(var r=0;4>r;r++)a+="	NO2-"+r;for(var r=0;6>r;r++)a+="	SOC-"+r;a+="	SOC-0-30",a+="	SOC-0-200";for(var r=0;1>r;r++)a+="	AOMf-"+r;for(var r=0;1>r;r++)a+="	AOMs-"+r;for(var r=0;1>r;r++)a+="	SMBf-"+r;for(var r=0;1>r;r++)a+="	SMBs-"+r;for(var r=0;1>r;r++)a+="	SOMf-"+r;for(var r=0;1>r;r++)a+="	SOMs-"+r;for(var r=0;1>r;r++)a+="	CBal-"+r;for(var r=0;3>r;r++)a+="	Nmin-"+r;a+="	NetNmin",a+="	Denit",a+="	N2O",a+="	SoilpH",a+="	NEP",a+="	NEE",a+="	Rh",a+="	tmin",a+="	tavg",a+="	tmax",a+="	wind",a+="	globrad",a+="	relhumid",a+="	sunhours",a+=i,a+="TTMMYYY",a+="	[ ]",a+="	[0;1]",a+="	[mm]",a+="	[0;1]",a+="	[0;1]",a+="	[0;1]",a+="	[ ]",a+="	[°Cd]",a+="	[0;1]",a+="	[0;1]",a+="	[kg/ha]",a+="	[kg/ha]",a+="	[kg/ha]",a+="	[kg/ha]",a+="	[0;1]",a+="	[kgDM/ha]",a+="	[kgDM/ha]",a+="	[kgDM/ha]",a+="	[kgDM/ha]",a+="	[kgDM/ha]",a+="	[kgCH2O/ha]",a+="	[kgCH2O/ha]",a+="	[kgCH2O/ha]",a+="	[kgCH2O/ha]",a+="	[s/m]",a+="	[m]",a+="	[m2/m2]",a+="	[layer]",a+="	[kg/ha]",a+="	[kgN/ha]",a+="	[kgN/ha]",a+="	[kgN/ha]",a+="	[kgN/ha]",a+="	[kgN/kg]",a+="	[kgN/kg]",a+="	[kgN/kg]",a+="	[kg C ha-1]",a+="	[kg C ha-1]",a+="	[kg C ha-1]",a+="	[kg C ha-1]",a+="	[kg C ha-1]",a+="	[kg C ha-1]",a+="	[kg C ha-1]",a+="	[kg C ha-1]",a+="	[kg C ha-1]",a+="	[kg C ha-1]",a+="	[kg C ha-1]";for(var r=0;t>r;r++)a+="	[m3/m3]";a+="	[mm]",a+="	[mm]",a+="	[mm]",a+="	[mm]",a+="	[mm]",a+="	[mm]",a+="	[m]",a+="	[m]";for(var r=0;t>r;r++)a+="	[m3/m3]";a+="	[°C]",a+="	[°C]",a+="	[°C]",a+="	[°C]",a+="	[°C]",a+="	[°C]",a+="	[mm]",a+="	[mm]",a+="	[mm]",a+="	[ ]",a+="	[ppm]",a+="	[m]",a+="	[mm]",a+="	[kgN/ha]";for(var r=0;t>r;r++)a+="	[kgN/m3]";a+="	[kgN/m3]";for(var r=0;t>r;r++)a+="	[kgN/m3]";for(var r=0;4>r;r++)a+="	[kgN/m3]";for(var r=0;6>r;r++)a+="	[kgC/kg]";a+="	[gC m-2]",a+="	[gC m-2]";for(var r=0;1>r;r++)a+="	[kgC/m3]";for(var r=0;1>r;r++)a+="	[kgC/m3]";for(var r=0;1>r;r++)a+="	[kgC/m3]";for(var r=0;1>r;r++)a+="	[kgC/m3]";for(var r=0;1>r;r++)a+="	[kgC/m3]";for(var r=0;1>r;r++)a+="	[kgC/m3]";for(var r=0;1>r;r++)a+="	[kgC/m3]";for(var r=0;3>r;r++)a+="	[kgN/ha]";a+="	[kgN/ha]",a+="	[kgN/ha]",a+="	[kgN/ha]",a+="	[ ]",a+="	[kgC/ha]",a+="	[kgC/ha]",a+="	[kgC/ha]",a+="	[°C]",a+="	[°C]",a+="	[°C]",a+="	[m/s]",a+="	globrad",a+="	[m3/m3]",a+="	[h]",a+=i,fs.writeFileSync(e,a,{encoding:"utf8"})},initializeGoutHeader=function(e){var t="",a="\n";t+="Datum     ",t+="	Crop",t+="	Stage",t+="	Height",t+="	Root",t+="	Root10",t+="	Leaf",t+="	Shoot",t+="	Fruit",t+="	AbBiom",t+="	AbGBiom",t+="	Yield",t+="	EarNo",t+="	GrainNo",t+="	LAI",t+="	AbBiomNc",t+="	YieldNc",t+="	AbBiomN",t+="	YieldN",t+="	TotNup",t+="	NGrain",t+="	Protein",t+="	BedGrad",t+="	M0-10",t+="	M10-20",t+="	M20-30",t+="	M30-40",t+="	M40-50",t+="	M50-60",t+="	M60-70",t+="	M70-80",t+="	M80-90",t+="	M0-30",t+="	M30-60",t+="	M60-90",t+="	M0-60",t+="	M0-90",t+="	PAW0-200",t+="	PAW0-130",t+="	PAW0-150",t+="	N0-30",t+="	N30-60",t+="	N60-90",t+="	N90-120",t+="	N0-60",t+="	N0-90",t+="	N0-200",t+="	N0-130",t+="	N0-150",t+="	NH430",t+="	NH460",t+="	NH490",t+="	Co0-10",t+="	Co0-30",t+="	T0-10",t+="	T20-30",t+="	T50-60",t+="	CO2",t+="	NH3",t+="	N2O",t+="	N2",t+="	Ngas",t+="	NFert",t+="	Irrig",t+=a,t+="TTMMYYYY",t+="	[ ]",t+="	[ ]",t+="	[m]",t+="	[kgDM/ha]",t+="	[kgDM/ha]",t+="	[kgDM/ha]",t+="	[kgDM/ha]",t+="	[kgDM/ha]",t+="	[kgDM/ha]",t+="	[kgDM/ha]",t+="	[kgDM/ha]",t+="	[ ]",t+="	[ ]",t+="	[m2/m2]",t+="	[kgN/kgDM",t+="	[kgN/kgDM]",t+="	[kgN/ha]",t+="	[kgN/ha]",t+="	[kgN/ha]",t+="	[-]",t+="	[kg/kgDM]",t+="	[0;1]",t+="	[m3/m3]",t+="	[m3/m3]",t+="	[m3/m3]",t+="	[m3/m3]",t+="	[m3/m3]",t+="	[m3/m3]",t+="	[m3/m3]",t+="	[m3/m3]",t+="	[m3/m3]",t+="	[m3/m3]",t+="	[m3/m3]",t+="	[m3/m3]",t+="	[m3/m3]",t+="	[m3/m3]",t+="	[mm]",t+="	[mm]",t+="	[mm]",t+="	[kgN/ha]",t+="	[kgN/ha]",t+="	[kgN/ha]",t+="	[kgN/ha]",t+="	[kgN/ha]",t+="	[kgN/ha]",t+="	[kgN/ha]",t+="	[kgN/ha]",t+="	[kgN/ha]",t+="	[kgN/ha]",t+="	[kgN/ha]",t+="	[kgN/ha]",t+="	[kgC/ha]",t+="	[kgC/ha]",t+="	[°C]",t+="	[°C]",t+="	[°C]",t+="	[kgC/ha]",t+="	[kgN/ha]",t+="	[-]",t+="	[-]",t+="	[-]",t+="	[kgN/ha]",t+="	[mm]",t+=a,fs.writeFileSync(e,t,{encoding:"utf8"})},writeCropResults=function(e,t,a,i){var r="",o="";if(i){r+="	"+e.get_CropName(),r+="	"+fixed(10,e.get_TranspirationDeficit()),r+="	"+fixed(10,e.get_ActualTranspiration()),r+="	"+fixed(10,e.get_CropNRedux()),r+="	"+fixed(10,e.get_HeatStressRedux()),r+="	"+fixed(10,e.get_OxygenDeficit()),r+="	"+fixed(10,e.get_DevelopmentalStage()+1),r+="	"+fixed(10,e.get_CurrentTemperatureSum()),r+="	"+fixed(10,e.get_VernalisationFactor()),r+="	"+fixed(10,e.get_DaylengthFactor()),r+="	"+fixed(10,e.get_OrganGrowthIncrement(0)),r+="	"+fixed(10,e.get_OrganGrowthIncrement(1)),r+="	"+fixed(10,e.get_OrganGrowthIncrement(2)),r+="	"+fixed(10,e.get_OrganGrowthIncrement(3)),r+="	"+fixed(10,e.get_RelativeTotalDevelopment()),r+="	"+fixed(10,e.get_OrganBiomass(0)),r+="	"+fixed(10,e.get_OrganBiomass(1)),r+="	"+fixed(10,e.get_OrganBiomass(2)),r+="	"+fixed(10,e.get_OrganBiomass(3)),r+="	"+fixed(10,e.get_PrimaryCropYield()),r+="	"+fixed(10,e.get_GrossPhotosynthesisHaRate()),r+="	"+fixed(10,e.get_NetPhotosynthesis()),r+="	"+fixed(10,e.get_MaintenanceRespirationAS()),r+="	"+fixed(10,e.get_GrowthRespirationAS()),r+="	"+fixed(10,e.get_StomataResistance()),r+="	"+fixed(10,e.get_CropHeight()),r+="	"+fixed(10,e.get_LeafAreaIndex()),r+="	"+fixed(10,e.get_RootingDepth()),r+="	"+fixed(10,e.get_AbovegroundBiomass()),r+="	"+fixed(10,e.get_TotalBiomassNContent()),r+="	"+fixed(10,e.get_SumTotalNUptake()),r+="	"+fixed(10,e.get_ActNUptake()),r+="	"+fixed(10,e.get_PotNUptake()),r+="	"+fixed(10,e.get_TargetNConcentration()),r+="	"+fixed(10,e.get_CriticalNConcentration()),r+="	"+fixed(10,e.get_AbovegroundBiomassNConcentration()),r+="	"+fixed(10,e.get_NetPrimaryProduction());
for(var n=0;n<e.get_NumberOfOrgans();n++)r+="	"+fixed(10,e.get_OrganSpecificNPP(n));for(var n=e.get_NumberOfOrgans();4>n;n++)r+="	0.0";r+="	"+fixed(10,e.get_GrossPrimaryProduction()),r+="	"+fixed(10,e.get_AutotrophicRespiration());for(var n=0;n<e.get_NumberOfOrgans();n++)r+="	"+fixed(10,e.get_OrganSpecificTotalRespired(n));for(var n=e.get_NumberOfOrgans();4>n;n++)r+="	0.0";o+="	"+e.get_CropName(),o+="	"+fixed(10,e.get_DevelopmentalStage()+1),o+="	"+fixed(10,e.get_CropHeight()),o+="	"+fixed(10,e.get_OrganBiomass(0)),o+="	"+fixed(10,e.get_OrganBiomass(0)),o+="	"+fixed(10,e.get_OrganBiomass(1)),o+="	"+fixed(10,e.get_OrganBiomass(2)),o+="	"+fixed(10,e.get_OrganBiomass(3)),o+="	"+fixed(10,e.get_AbovegroundBiomass()),o+="	"+fixed(10,e.get_AbovegroundBiomass()),o+="	"+fixed(10,e.get_PrimaryCropYield()),o+="	0",o+="	0",o+="	"+fixed(10,e.get_LeafAreaIndex()),o+="	"+fixed(10,e.get_AbovegroundBiomassNConcentration()),o+="	"+fixed(10,e.get_PrimaryYieldNConcentration()),o+="	"+fixed(10,e.get_AbovegroundBiomassNContent()),o+="	"+fixed(10,e.get_PrimaryYieldNContent()),o+="	"+fixed(10,e.get_TotalBiomassNContent()),o+="	0",o+="	"+fixed(10,e.get_RawProteinConcentration())}else r+="	",r+="	1.00",r+="	0.00",r+="	1.00",r+="	1.00",r+="	1.00",r+="	0",r+="	0.0",r+="	0.00",r+="	0.00",r+="	0.00",r+="	0.00",r+="	0.00",r+="	0.00",r+="	0.00",r+="	0.0",r+="	0.0",r+="	0.0",r+="	0.0",r+="	0.0",r+="	0.000",r+="	0.00",r+="	0.000",r+="	0.000",r+="	0.00",r+="	0.00",r+="	0.00",r+="	0",r+="	0.0",r+="	0.0",r+="	0.00",r+="	0.00",r+="	0.00",r+="	0.000",r+="	0.000",r+="	0.000",r+="	0.0",r+="	0.0",r+="	0.0",r+="	0.0",r+="	0.0",r+="	0.0",r+="	0.0",r+="	0.0",r+="	0.0",r+="	0.0",r+="	0.0",o+="	",o+="	0",o+="	0.00",o+="	0.0",o+="	0.0",o+="	0.0",o+="	0.0",o+="	0.0",o+="	0.0",o+="	0.0",o+="	0.0",o+="	0",o+="	0",o+="	0.00",o+="	0.000",o+="	0.0",o+="	0.00",o+="	0.0",o+="	0.0",o+="	0",o+="	0.00";fs.appendFileSync(a,o,{encoding:"utf8"}),fs.appendFileSync(t,r,{encoding:"utf8"})},writeGeneralResults=function(e,t,a,i,r){for(var o="",n="",_="\n",s=i.soilTemperature(),l=i.soilMoisture(),c=i.soilOrganic(),g=i.soilColumn(),p=i.soilColumnNC(),d=i.soilTransport(),m=20,f=0;m>f;f++)o+="	"+fixed(10,l.get_SoilMoisture(f));o+="	"+fixed(10,a.da.dataForTimestep(Climate.precip,r)),o+="	"+fixed(10,i.dailySumIrrigationWater()),o+="	"+fixed(10,l.get_Infiltration()),o+="	"+fixed(10,l.get_SurfaceWaterStorage()),o+="	"+fixed(10,l.get_SurfaceRunOff()),o+="	"+fixed(10,l.get_SnowDepth()),o+="	"+fixed(10,l.get_FrostDepth()),o+="	"+fixed(10,l.get_ThawDepth());for(var f=0;m>f;f++)o+="	"+fixed(10,l.get_SoilMoisture(f)-p[f].get_PermanentWiltingPoint());o+="	"+fixed(10,s.get_SoilSurfaceTemperature());for(var f=0;5>f;f++)o+="	"+fixed(10,s.get_SoilTemperature(f));o+="	"+fixed(10,l.get_ActualEvaporation()),o+="	"+fixed(10,l.get_Evapotranspiration()),o+="	"+fixed(10,l.get_ET0()),o+="	"+fixed(10,l.get_KcFactor()),o+="	"+fixed(10,i.get_AtmosphericCO2Concentration()),o+="	"+fixed(10,i.get_GroundwaterDepth()),o+="	"+fixed(10,l.get_GroundwaterRecharge()),o+="	"+fixed(10,d.get_NLeaching());for(var f=0;m>f;f++)o+="	"+fixed(10,g.soilLayer(f).get_SoilNO3());o+="	"+fixed(10,g.soilLayer(0).get_SoilCarbamid());for(var f=0;m>f;f++)o+="	"+fixed(10,g.soilLayer(f).get_SoilNH4());for(var f=0;4>f;f++)o+="	"+fixed(10,g.soilLayer(f).get_SoilNO2());for(var f=0;6>f;f++)o+="	"+fixed(10,g.soilLayer(f).vs_SoilOrganicCarbon());for(var u=0,f=0;3>f;f++)u+=g.soilLayer(f).vs_SoilOrganicCarbon()*g.soilLayer(f).vs_SoilBulkDensity()*g.soilLayer(f).vs_LayerThickness*1e3;o+="	"+fixed(10,u);for(var S=0,f=0;m>f;f++)S+=g.soilLayer(f).vs_SoilOrganicCarbon()*g.soilLayer(f).vs_SoilBulkDensity()*g.soilLayer(f).vs_LayerThickness*1e3;o+="	"+fixed(10,S);for(var f=0;1>f;f++)o+="	"+fixed(10,c.get_AOM_FastSum(f));for(var f=0;1>f;f++)o+="	"+fixed(10,c.get_AOM_SlowSum(f));for(var f=0;1>f;f++)o+="	"+fixed(10,c.get_SMB_Fast(f));for(var f=0;1>f;f++)o+="	"+fixed(10,c.get_SMB_Slow(f));for(var f=0;1>f;f++)o+="	"+fixed(10,c.get_SOM_Fast(f));for(var f=0;1>f;f++)o+="	"+fixed(10,c.get_SOM_Slow(f));for(var f=0;1>f;f++)o+="	"+fixed(10,c.get_CBalance(f));for(var f=0;3>f;f++)o+="	"+fixed(10,c.get_NetNMineralisationRate(f));o+="	"+fixed(10,c.get_NetNMineralisation()),o+="	"+fixed(10,c.get_Denitrification()),o+="	"+fixed(10,c.get_N2O_Produced()),o+="	"+fixed(10,g.soilLayer(0).get_SoilpH()),o+="	"+fixed(10,c.get_NetEcosystemProduction()),o+="	"+fixed(10,c.get_NetEcosystemExchange()),o+="	"+fixed(10,c.get_DecomposerRespiration()),o+="	"+fixed(10,a.da.dataForTimestep(Climate.tmin,r)),o+="	"+fixed(10,a.da.dataForTimestep(Climate.tavg,r)),o+="	"+fixed(10,a.da.dataForTimestep(Climate.tmax,r)),o+="	"+fixed(10,a.da.dataForTimestep(Climate.wind,r)),o+="	"+fixed(10,a.da.dataForTimestep(Climate.globrad,r)),o+="	"+fixed(10,a.da.dataForTimestep(Climate.relhumid,r)),o+="	"+fixed(10,a.da.dataForTimestep(Climate.sunhours,r)),o+=_,n+="	"+fixed(10,l.get_PercentageSoilCoverage());for(var f=0;9>f;f++)n+="	"+fixed(10,l.get_SoilMoisture(f));n+="	"+fixed(10,(l.get_SoilMoisture(0)+l.get_SoilMoisture(1)+l.get_SoilMoisture(2))/3),n+="	"+fixed(10,(l.get_SoilMoisture(3)+l.get_SoilMoisture(4)+l.get_SoilMoisture(5))/3),n+="	"+fixed(10,(l.get_SoilMoisture(6)+l.get_SoilMoisture(7)+l.get_SoilMoisture(8))/3);for(var h=0,f=0;6>f;f++)h+=l.get_SoilMoisture(f);n+="	"+fixed(10,h/6);for(var O=0,f=0;9>f;f++)O+=l.get_SoilMoisture(f);n+="	"+fixed(10,O/9);for(var x=0,f=0;20>f;f++)x+=l.get_SoilMoisture(f)-p[f].get_PermanentWiltingPoint();n+="	"+fixed(10,.1*x*1e3);for(var M=0,f=0;13>f;f++)M+=l.get_SoilMoisture(f)-p[f].get_PermanentWiltingPoint();n+="	"+fixed(10,.1*M*1e3);for(var y=0,f=0;15>f;f++)y+=l.get_SoilMoisture(f)-p[f].get_PermanentWiltingPoint();n+="	"+fixed(10,.1*y*1e3),n+="	"+fixed(10,(g.soilLayer(0).get_SoilNmin()+g.soilLayer(1).get_SoilNmin()+g.soilLayer(2).get_SoilNmin())/3*.3*1e4),n+="	"+fixed(10,(g.soilLayer(3).get_SoilNmin()+g.soilLayer(4).get_SoilNmin()+g.soilLayer(5).get_SoilNmin())/3*.3*1e4),n+="	"+fixed(10,(g.soilLayer(6).get_SoilNmin()+g.soilLayer(7).get_SoilNmin()+g.soilLayer(8).get_SoilNmin())/3*.3*1e4),n+="	"+fixed(10,(g.soilLayer(9).get_SoilNmin()+g.soilLayer(10).get_SoilNmin()+g.soilLayer(11).get_SoilNmin())/3*.3*1e4);for(var v=0,f=0;6>f;f++)v+=g.soilLayer(f).get_SoilNmin();n+="	"+fixed(10,.1*v*1e4);for(var C=0,f=0;9>f;f++)C+=g.soilLayer(f).get_SoilNmin();n+="	"+fixed(10,.1*C*1e4);for(var N=0,f=0;20>f;f++)N+=g.soilLayer(f).get_SoilNmin();n+="	"+fixed(10,.1*N*1e4);for(var R=0,f=0;13>f;f++)R+=g.soilLayer(f).get_SoilNmin();n+="	"+fixed(10,.1*R*1e4);for(var P=0,f=0;15>f;f++)P+=g.soilLayer(f).get_SoilNmin();n+="	"+fixed(10,.1*P*1e4),n+="	"+fixed(10,(g.soilLayer(0).get_SoilNH4()+g.soilLayer(1).get_SoilNH4()+g.soilLayer(2).get_SoilNH4())/3*.3*1e4),n+="	"+fixed(10,(g.soilLayer(3).get_SoilNH4()+g.soilLayer(4).get_SoilNH4()+g.soilLayer(5).get_SoilNH4())/3*.3*1e4),n+="	"+fixed(10,(g.soilLayer(6).get_SoilNH4()+g.soilLayer(7).get_SoilNH4()+g.soilLayer(8).get_SoilNH4())/3*.3*1e4),n+="	"+fixed(10,.1*c.get_SoilOrganicC(0)*1e4),n+="	"+fixed(10,(c.get_SoilOrganicC(0)+c.get_SoilOrganicC(1)+c.get_SoilOrganicC(2))/3*.3*1e4),n+="	"+fixed(10,s.get_SoilTemperature(0)),n+="	"+fixed(10,s.get_SoilTemperature(2)),n+="	"+fixed(10,s.get_SoilTemperature(5)),n+="	"+fixed(10,c.get_DecomposerRespiration()),n+="	"+fixed(10,c.get_NH3_Volatilised()),n+="	0",n+="	0",n+="	0",n+="	"+fixed(10,i.dailySumFertiliser()),n+="	"+fixed(10,i.dailySumIrrigationWater()),n+=_,fs.appendFileSync(t,n,{encoding:"utf8"}),fs.appendFileSync(e,o,{encoding:"utf8"})},dumpMonicaParametersIntoFile=function(e,t){var a="",i="\n";a+="userSoilOrganicParameters	po_SOM_SlowDecCoeffStandard	"+t.userSoilOrganicParameters.po_SOM_SlowDecCoeffStandard+i,a+="userSoilOrganicParameters	po_SOM_FastDecCoeffStandard	"+t.userSoilOrganicParameters.po_SOM_FastDecCoeffStandard+i,a+="userSoilOrganicParameters	po_SMB_SlowMaintRateStandard	"+t.userSoilOrganicParameters.po_SMB_SlowMaintRateStandard+i,a+="userSoilOrganicParameters	po_SMB_FastMaintRateStandard	"+t.userSoilOrganicParameters.po_SMB_FastMaintRateStandard+i,a+="userSoilOrganicParameters	po_SMB_SlowDeathRateStandard	"+t.userSoilOrganicParameters.po_SMB_SlowDeathRateStandard+i,a+="userSoilOrganicParameters	po_SMB_FastDeathRateStandard	"+t.userSoilOrganicParameters.po_SMB_FastDeathRateStandard+i,a+="userSoilOrganicParameters	po_SMB_UtilizationEfficiency	"+t.userSoilOrganicParameters.po_SMB_UtilizationEfficiency+i,a+="userSoilOrganicParameters	po_SOM_SlowUtilizationEfficiency	"+t.userSoilOrganicParameters.po_SOM_SlowUtilizationEfficiency+i,a+="userSoilOrganicParameters	po_SOM_FastUtilizationEfficiency	"+t.userSoilOrganicParameters.po_SOM_FastUtilizationEfficiency+i,a+="userSoilOrganicParameters	po_AOM_SlowUtilizationEfficiency	"+t.userSoilOrganicParameters.po_AOM_SlowUtilizationEfficiency+i,a+="userSoilOrganicParameters	po_AOM_FastUtilizationEfficiency	"+t.userSoilOrganicParameters.po_AOM_FastUtilizationEfficiency+i,a+="userSoilOrganicParameters	po_AOM_FastMaxC_to_N	"+t.userSoilOrganicParameters.po_AOM_FastMaxC_to_N+i,a+="userSoilOrganicParameters	po_PartSOM_Fast_to_SOM_Slow	"+t.userSoilOrganicParameters.po_PartSOM_Fast_to_SOM_Slow+i,a+="userSoilOrganicParameters	po_PartSMB_Slow_to_SOM_Fast	"+t.userSoilOrganicParameters.po_PartSMB_Slow_to_SOM_Fast+i,a+="userSoilOrganicParameters	po_PartSMB_Fast_to_SOM_Fast	"+t.userSoilOrganicParameters.po_PartSMB_Fast_to_SOM_Fast+i,a+="userSoilOrganicParameters	po_PartSOM_to_SMB_Slow	"+t.userSoilOrganicParameters.po_PartSOM_to_SMB_Slow+i,a+="userSoilOrganicParameters	po_PartSOM_to_SMB_Fast	"+t.userSoilOrganicParameters.po_PartSOM_to_SMB_Fast+i,a+="userSoilOrganicParameters	po_CN_Ratio_SMB	"+t.userSoilOrganicParameters.po_CN_Ratio_SMB+i,a+="userSoilOrganicParameters	po_LimitClayEffect	"+t.userSoilOrganicParameters.po_LimitClayEffect+i,a+="userSoilOrganicParameters	po_AmmoniaOxidationRateCoeffStandard	"+t.userSoilOrganicParameters.po_AmmoniaOxidationRateCoeffStandard+i,a+="userSoilOrganicParameters	po_NitriteOxidationRateCoeffStandard	"+t.userSoilOrganicParameters.po_NitriteOxidationRateCoeffStandard+i,a+="userSoilOrganicParameters	po_TransportRateCoeff	"+t.userSoilOrganicParameters.po_TransportRateCoeff+i,a+="userSoilOrganicParameters	po_SpecAnaerobDenitrification	"+t.userSoilOrganicParameters.po_SpecAnaerobDenitrification+i,a+="userSoilOrganicParameters	po_ImmobilisationRateCoeffNO3	"+t.userSoilOrganicParameters.po_ImmobilisationRateCoeffNO3+i,a+="userSoilOrganicParameters	po_ImmobilisationRateCoeffNH4	"+t.userSoilOrganicParameters.po_ImmobilisationRateCoeffNH4+i,a+="userSoilOrganicParameters	po_Denit1	"+t.userSoilOrganicParameters.po_Denit1+i,a+="userSoilOrganicParameters	po_Denit2	"+t.userSoilOrganicParameters.po_Denit2+i,a+="userSoilOrganicParameters	po_Denit3	"+t.userSoilOrganicParameters.po_Denit3+i,a+="userSoilOrganicParameters	po_HydrolysisKM	"+t.userSoilOrganicParameters.po_HydrolysisKM+i,a+="userSoilOrganicParameters	po_ActivationEnergy	"+t.userSoilOrganicParameters.po_ActivationEnergy+i,a+="userSoilOrganicParameters	po_HydrolysisP1	"+t.userSoilOrganicParameters.po_HydrolysisP1+i,a+="userSoilOrganicParameters	po_HydrolysisP2	"+t.userSoilOrganicParameters.po_HydrolysisP2+i,a+="userSoilOrganicParameters	po_AtmosphericResistance	"+t.userSoilOrganicParameters.po_AtmosphericResistance+i,a+="userSoilOrganicParameters	po_N2OProductionRate	"+t.userSoilOrganicParameters.po_N2OProductionRate+i,a+="userSoilOrganicParameters	po_Inhibitor_NH3	"+t.userSoilOrganicParameters.po_Inhibitor_NH3+i,a+=i,fs.writeFileSync(e,a,{encoding:"utf8"})},getProgress=function(e,t){for(var a=t.isCropPlanted(),i=t.cropGrowth(),r=t.soilTemperature(),o=t.soilMoisture(),n=t.soilOrganic(),_=t.soilColumn(),s=t.soilColumnNC(),l=t.soilTransport(),c={date:e.toLocaleDateString(),CropName:a?i.get_CropName():"",TranspirationDeficit:a?i.get_TranspirationDeficit():0,ActualTranspiration:a?i.get_ActualTranspiration():0,CropNRedux:a?i.get_CropNRedux():0,HeatStressRedux:a?i.get_HeatStressRedux():0,OxygenDeficit:a?i.get_OxygenDeficit():0,DevelopmentalStage:a?i.get_DevelopmentalStage()+1:0,CurrentTemperatureSum:a?i.get_CurrentTemperatureSum():0,VernalisationFactor:a?i.get_VernalisationFactor():0,DaylengthFactor:a?i.get_DaylengthFactor():0,OrganGrowthIncrementRoot:a?i.get_OrganGrowthIncrement(0):0,OrganGrowthIncrementLeaf:a?i.get_OrganGrowthIncrement(1):0,OrganGrowthIncrementShoot:a?i.get_OrganGrowthIncrement(2):0,OrganGrowthIncrementFruit:a?i.get_OrganGrowthIncrement(3):0,RelativeTotalDevelopment:a?i.get_RelativeTotalDevelopment():0,OrganBiomassRoot:a?i.get_OrganBiomass(0):0,OrganBiomassLeaf:a?i.get_OrganBiomass(1):0,OrganBiomassShoot:a?i.get_OrganBiomass(2):0,OrganBiomassFruit:a?i.get_OrganBiomass(3):0,PrimaryCropYield:a?i.get_PrimaryCropYield():0,GrossPhotosynthesisHaRate:a?i.get_GrossPhotosynthesisHaRate():0,NetPhotosynthesis:a?i.get_NetPhotosynthesis():0,MaintenanceRespirationAS:a?i.get_MaintenanceRespirationAS():0,GrowthRespirationAS:a?i.get_GrowthRespirationAS():0,StomataResistance:a?i.get_StomataResistance():0,CropHeight:a?i.get_CropHeight():0,LeafAreaIndex:a?i.get_LeafAreaIndex():0,RootingDepth:a?i.get_RootingDepth():0,AbovegroundBiomass:a?i.get_AbovegroundBiomass():0,TotalBiomassNContent:a?i.get_TotalBiomassNContent():0,SumTotalNUptake:a?i.get_SumTotalNUptake():0,ActNUptake:a?i.get_ActNUptake():0,PotNUptake:a?i.get_PotNUptake():0,TargetNConcentration:a?i.get_TargetNConcentration():0,CriticalNConcentration:a?i.get_CriticalNConcentration():0,AbovegroundBiomassNConcentration:a?i.get_AbovegroundBiomassNConcentration():0,NetPrimaryProduction:a?i.get_NetPrimaryProduction():0,GrossPrimaryProduction:a?i.get_GrossPrimaryProduction():0,AutotrophicRespiration:a?i.get_AutotrophicRespiration():0},g=20,p=0;g>p;p++)c["SoilMoisture_"+p]=o.get_SoilMoisture(p);c.dailySumIrrigationWater=t.dailySumIrrigationWater(),c.Infiltration=o.get_Infiltration(),c.SurfaceWaterStorage=o.get_SurfaceWaterStorage(),c.SurfaceRunOff=o.get_SurfaceRunOff(),c.SnowDepth=o.get_SnowDepth(),c.FrostDepth=o.get_FrostDepth(),c.ThawDepth=o.get_ThawDepth();for(var p=0;g>p;p++)c["PASW_"+p]=o.get_SoilMoisture(p)-s[p].get_PermanentWiltingPoint();c.SoilSurfaceTemperature=r.get_SoilSurfaceTemperature();for(var p=0;5>p;p++)c["SoilTemperature_"+p]=r.get_SoilTemperature(p);c.ActualEvaporation=o.get_ActualEvaporation(),c.Evapotranspiration=o.get_Evapotranspiration(),c.ET0=o.get_ET0(),c.KcFactor=o.get_KcFactor(),c.AtmosphericCO2Concentration=t.get_AtmosphericCO2Concentration(),c.GroundwaterDepth=t.get_GroundwaterDepth(),c.GroundwaterRecharge=o.get_GroundwaterRecharge(),c.NLeaching=l.get_NLeaching();for(var p=0;g>p;p++)c["SoilNO3_"+p]=_.soilLayer(p).get_SoilNO3();c.SoilCarbamid=_.soilLayer(0).get_SoilCarbamid();for(var p=0;g>p;p++)c["SoilNH4_"+p]=_.soilLayer(p).get_SoilNH4();for(var p=0;4>p;p++)c["SoilNO2_"+p]=_.soilLayer(p).get_SoilNO2();for(var p=0;6>p;p++)c["SoilOrganicCarbon_"+p]=_.soilLayer(p).vs_SoilOrganicCarbon();for(var d=0,p=0;3>p;p++)d+=_.soilLayer(p).vs_SoilOrganicCarbon()*_.soilLayer(p).vs_SoilBulkDensity()*_.soilLayer(p).vs_LayerThickness*1e3;c.soc_30_accumulator=d;for(var m=0,p=0;g>p;p++)m+=_.soilLayer(p).vs_SoilOrganicCarbon()*_.soilLayer(p).vs_SoilBulkDensity()*_.soilLayer(p).vs_LayerThickness*1e3;c.soc_200_accumulator=m;for(var p=0;1>p;p++)c["AOM_FastSum_"+p]=n.get_AOM_FastSum(p);for(var p=0;1>p;p++)c["AOM_SlowSum_"+p]=n.get_AOM_SlowSum(p);for(var p=0;1>p;p++)c["SMB_Fast_"+p]=n.get_SMB_Fast(p);for(var p=0;1>p;p++)c["SMB_Slow_"+p]=n.get_SMB_Slow(p);for(var p=0;1>p;p++)c["SOM_Fast_"+p]=n.get_SOM_Fast(p);for(var p=0;1>p;p++)c["SOM_Slow_"+p]=n.get_SOM_Slow(p);for(var p=0;1>p;p++)c["CBalance_"+p]=n.get_CBalance(p);for(var p=0;3>p;p++)c["NetNMineralisationRate_"+p]=n.get_NetNMineralisationRate(p);return c.NetNMineralisation=n.get_NetNMineralisation(),c.Denitrification=n.get_Denitrification(),c.N2O_Produced=n.get_N2O_Produced(),c.SoilpH_0=_.soilLayer(0).get_SoilpH(),c.NetEcosystemProduction=n.get_NetEcosystemProduction(),c.NetEcosystemExchange=n.get_NetEcosystemExchange(),c.DecomposerRespiration=n.get_DecomposerRespiration(),c};
...
var Configuration=function(e,r,a){function t(e,r){var a=!0,t=r.length;logger(MSG.INFO,"fetching "+t+" crops");for(var s=0;t>s;s++){var g=r[s],d=-1,c=g.nameAndGenType,m=db.exec("SELECT crop_id         FROM view_crop         WHERE name_and_gentype='"+c+"'");m.length>0&&(d=m[0].values[0][0]),(0>d||isNaN(d))&&(a=!1,logger(MSG.ERROR,"invalid crop id: "+c));var u=new Date(Date.parse(g.sowingDate)),p=new Date(Date.parse(g.finalHarvestDate));debug(c,"nameAndGenType"),debug(u,"sd"),debug(p,"hd"),u.isValid()&&p.isValid()||(a=!1,logger(MSG.ERROR,"invalid sowing or harvest date"));var v=new Crop(d,c);v.setSeedAndHarvestDate(u,p),v.setCropParameters(getCropParameters(v.id())),v.setResidueParameters(getResidueParameters(v.id())),e[s]=new ProductionProcess(c,v);var h=g.tillageOperations;h&&(i(e[s],h)||(a=!1,logger(MSG.ERROR,"error adding tillages")));var S=g.mineralFertilisers;S&&(n(e[s],S,!1)||(a=!1,logger(MSG.ERROR,"error adding mineral fertilisers")));var R=g.organicFertilisers;R&&(n(e[s],R,!0)||(a=!1,logger(MSG.ERROR,"error adding organic fertilisers")));var f=g.irrigations;f&&(o(e[s],f)||(a=!1,logger(MSG.ERROR,"error adding irrigations")));var O=g.cuttings;O&&(l(e[s],O)||(a=!1,logger(MSG.ERROR,"error adding cuttings"))),logger(MSG.INFO,"fetched crop "+s+", nameAndGenType: "+c+", id: "+d)}return a}function i(e,r){var a=!0,t=r.length;logger(MSG.INFO,"fetching "+t+" tillages");for(var i=0;t>i;++i){var n=r[i];if(null!==n.date&&null!==n.depth&&null!==n.method){{var o=new Date(Date.parse(n.date)),l=n.depth/100;n.method}o.isValid()||(a=!1,logger(MSG.ERROR,"invalid tillage date in tillage no. "+i)),e.addApplication(new TillageApplication(o,l)),logger(MSG.INFO,"fetched tillage "+i)}else logger(MSG.WARN,"at least one tillage parameter null: tillage "+i+" ignored")}return a}function n(e,r,a){var t=!0,i=r.length;logger(MSG.INFO,"fetching "+i+" "+(a?"organic":"mineral")+" fertilisers");for(var n=0;i>n;++n){var o=r[n];if(null!==o.date&&null!==o.method&&null!==o.type&&null!==o.amount){var l=new Date(Date.parse(o.date)),s=(o.method,o.type),g=o.amount;if(l.isValid()||(t=!1,logger(MSG.ERROR,"invalid fertilization date in "+n)),a){var d=-1,c=db.exec("SELECT id           FROM organic_fertiliser           WHERE om_type='"+s+"'");c.length>0&&(d=c[0].values[0][0]),0>d&&(logger(MSG.ERROR,"organic fertilser "+s+" not found"),t=!1),e.addApplication(new OrganicFertiliserApplication(l,getOrganicFertiliserParameters(d),g,!0))}else{var m=-1,c=db.exec("SELECT id           FROM mineral_fertilisers           WHERE name='"+s+"'");c.length>0&&(m=c[0].values[0][0]),0>m&&(logger(MSG.ERROR,"mineral fertilser "+s+" not found"),t=!1),e.addApplication(new MineralFertiliserApplication(l,getMineralFertiliserParameters(m),g))}logger(MSG.INFO,"fetched "+(a?"organic":"mineral")+" fertiliser "+n)}else logger(MSG.WARN,"at least one fertiliser parameter null: "+(a?"organic":"mineral")+" fertiliser "+n+"ignored")}return t}function o(e,r){var a=!0,t=r.length;logger(MSG.INFO,"fetching "+t+" irrigations");for(var i=0;t>i;++i){var n=r[i];if(null!==n.date&&null!==n.method&&null!==n.eventType&&null!==n.threshold&&null!==n.amount&&null!==n.NConc){var o=(n.method,n.eventType,n.threshold,n.area,n.amount),l=n.NConc,s=new Date(Date.parse(n.date));s.isValid()||(a=!1,logger(MSG.ERROR,"invalid irrigation date in "+i)),e.addApplication(new IrrigationApplication(s,o,new IrrigationParameters(l,0))),logger(MSG.INFO,"fetched irrigation "+i)}else logger(MSG.WARN,"at least one irrigation parameter null: irrigation "+i+" ignored")}return a}function l(e,r){var a=!0,t=r.length;logger(MSG.INFO,"fetching "+t+" cuttings");for(var i=0;t>i;++i){var n=r[i],o=new Date(Date.parse(n.date));e.addApplication(new Cutting(o,e.crop(),e.cropResult()))}return a}function s(e){var a=!1;return r&&(e.addClimateData(Climate.tmin,new Float64Array(r.tmin)),e.addClimateData(Climate.tmax,new Float64Array(r.tmax)),e.addClimateData(Climate.tavg,new Float64Array(r.tavg)),e.addClimateData(Climate.globrad,new Float64Array(r.globrad)),e.addClimateData(Climate.wind,new Float64Array(r.wind)),e.addClimateData(Climate.precip,new Float64Array(r.precip)),r.sunhours.length>0&&e.addClimateData(Climate.sunhours,new Float64Array(r.sunhours)),r.relhumid.length>0&&e.addClimateData(Climate.relhumid,new Float64Array(r.relhumid)),a=!0),a}DEBUG=a===!0?!0:!1;var g=e,d=function(e,r,a){logger(MSG.INFO,"fetching parameters from database");var i=new SiteParameters,n=readUserParameterFromDatabase(),o=new GeneralParameters(n.userEnvironmentParameters.p_LayerThickness,n.userEnvironmentParameters.p_LayerThickness*n.userEnvironmentParameters.p_NumberOfLayers),l=r.horizons,d=a.crops,u=new Date(Date.parse(e.time.startDate)).getFullYear(),p=new Date(Date.parse(e.time.endDate)).getFullYear();n.userEnvironmentParameters.p_UseSecondaryYields=e.switch.useSecondaryYieldOn===!0?!0:!1,o.pc_NitrogenResponseOn=e.switch.nitrogenResponseOn===!0?!0:!1,o.pc_WaterDeficitResponseOn=e.switch.waterDeficitResponseOn===!0?!0:!1,o.pc_EmergenceMoistureControlOn=e.switch.emergenceMoistureControlOn===!0?!0:!1,o.pc_EmergenceFloodingControlOn=e.switch.emergenceFloodingControlOn===!0?!0:!1,n.userInitValues.p_initPercentageFC=e.init.percentageFC,n.userInitValues.p_initSoilNitrate=e.init.soilNitrate,n.userInitValues.p_initSoilAmmonium=e.init.soilAmmonium,logger(MSG.INFO,"fetched sim data"),i.vq_NDeposition=r.NDeposition,i.vs_Latitude=r.latitude,i.vs_Slope=r.slope,i.vs_HeightNN=r.heightNN,i.vs_Soil_CN_Ratio=10,i.vs_DrainageCoeff=-1,n.userEnvironmentParameters.p_AthmosphericCO2=r.atmosphericCO2,n.userEnvironmentParameters.p_WindSpeedHeight=r.windSpeedHeight,n.userEnvironmentParameters.p_LeachingDepth=r.leachingDepth,o.ps_MaxMineralisationDepth=.4,logger(MSG.INFO,"fetched site data");var v=100*n.userEnvironmentParameters.p_LayerThickness,h=200,S=int(h/v),R=[];if(!c(R,l,v,S))return void logger(MSG.ERROR,"error fetching soil data");logger(MSG.INFO,"fetched soil data");var f=new DataAccessor(new Date(u,0,1),new Date(p,11,31));if(!s(f,n,i.vs_Latitude))return void logger(MSG.ERROR,"error fetching climate data");logger(MSG.INFO,"fetched climate data");var O=[];if(!t(O,d))return void logger(MSG.ERROR,"error fetching crop data");logger(MSG.INFO,"fetched crop data");var _=new Environment(R,n);return _.general=o,_.pathToOutputDir=g,_.site=i,_.da=f,_.cropRotation=O,logger(MSG.INFO,"start monica model"),runMonica(_,m)},c=function(e,r,a,t){var i=!0,n=r.length;logger(MSG.INFO,"fetching "+n+" horizons");for(var o=0;n>o;++o){var l=r[o],s=100*l.thickness,g=int(round(s/a));o==n-1&&int(e.length)+g<t&&(g+=t-e.length-g);for(var d=0;g>d;d++){var c=new SoilParameters;c.set_vs_SoilOrganicCarbon(l.Corg),l.bulkDensity&&c.set_vs_SoilBulkDensity(l.bulkDensity),c.vs_SoilSandContent=l.sand,c.vs_SoilClayContent=l.clay,c.vs_SoilStoneContent=l.sceleton,c.vs_Lambda=Tools.texture2lambda(c.vs_SoilSandContent,c.vs_SoilClayContent),c.vs_SoilTexture=l.textureClass,c.vs_SoilpH=l.pH,c.vs_Lambda=Tools.texture2lambda(c.vs_SoilSandContent,c.vs_SoilClayContent),c.vs_FieldCapacity=l.fieldCapacity,c.vs_Saturation=l.poreVolume,c.vs_PermanentWiltingPoint=l.permanentWiltingPoint,c.isValid()||(i=!1,logger(MSG.ERROR,"error in soil parameters")),e.push(c),logger(MSG.INFO,"fetched layer "+e.length+" in horizon "+o)}logger(MSG.INFO,"fetched horizon "+o)}return i},m=function(e){ENVIRONMENT_IS_WORKER?postMessage({progress:e}):logger(MSG.INFO,e.date)};return{run:d}};
